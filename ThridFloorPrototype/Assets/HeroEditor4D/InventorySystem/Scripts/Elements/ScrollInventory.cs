...
namespace Assets.HeroEditor4D.InventorySystem.Scripts.Elements
{
    ...
    public class ScrollInventory : ItemContainer
    {
        ...
        public void SelectItem(Item item)
        {
            ...
            {
                instance.Select(instance.Item == item);
            }
        }
        ...
        public void CheckItemExistsAndToggle(string itemId, Toggle toggle)
        {
            var itemExists = Items.Any(i => i.Id == itemId);
            toggle.interactable = itemExists;
        }
        ...
        private InventoryItem GetItemInstance()
        {
            ...
            if (instance == null)
            {
               ...
               /* var toggle = instance.GetComponent<Toggle>();
                if (toggle != null)
                {
                    var itemId = instance.Item.Id;
                    CheckItemExistsAndToggle(itemId, toggle);
                }*/
            }
            else
            {
